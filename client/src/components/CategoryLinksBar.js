  ...
  return (
    <div className="category-links-container">
      <div className="CategoryLinksBar">
        <div className="category-group" onClick={()=>setCategories(1)}>
          {/* <Link to="/category/1" onClick={()=>setCategory(1)}> */}
            <img src={PersonIcon} alt="one-person-package" height="40px" />
          {/* </Link> */}
        </div>

        <div className="category-group" onClick={()=>setCategories(2)}>
        ...
        <div className="category-group" onClick={()=>setCategories(3)}>
        ...
        <div className="category-group" onClick={()=>setCategories(4)}>
